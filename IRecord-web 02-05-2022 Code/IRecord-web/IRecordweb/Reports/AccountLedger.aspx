<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountLedger.aspx.cs" Inherits="IRecordweb.Reports.AccountLedger" %>
                ...
                <div class="card-body">
                    <div class="row form_2 inner_font_size">
                        ...
                        <div class="col-sm-12 col-md-6 mb-3 d-flex">
                            ...
                            <asp:ListBox ID="ListGroup" CssClass="select2" runat="server" AutoPostBack="true"
